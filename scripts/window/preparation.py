...
# ------------------
# Sub window class for handle the preperation of map images
# ---------------------------------------------------------------
class PreperationSubWindow(Window):
...
# ------------------
# Window class for handle the preperation of map images
# -----------------------------------------------------------
class PreperationWindow(Window):
